...
if ISSUETRACKER_HOTLIST_ID:
  ISSUETRACKER_HOTLIST_ID = int(ISSUETRACKER_HOTLIST_ID)

ISSUETRACKER_COMPONENT_ID = os.environ.get('ISSUETRACKER_COMPONENT_ID')

if ISSUETRACKER_COMPONENT_ID:
  ISSUETRACKER_COMPONENT_ID = int(ISSUETRACKER_COMPONENT_ID)

ISSUETRACKER_ISSUE_COMPONENT_ID = os.environ.get(
    'ISSUETRACKER_ISSUE_COMPONENT_ID'
)

if ISSUETRACKER_ISSUE_COMPONENT_ID:
  ISSUETRACKER_ISSUE_COMPONENT_ID = int(ISSUETRACKER_ISSUE_COMPONENT_ID)

ISSUETRACKER_ISSUE_HOTLIST_ID = os.environ.get(
    'ISSUETRACKER_ISSUE_HOTLIST_ID'
)

if ISSUETRACKER_ISSUE_HOTLIST_ID:
  ISSUETRACKER_ISSUE_HOTLIST_ID = int(ISSUETRACKER_ISSUE_HOTLIST_ID)
